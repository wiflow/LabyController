...
import net.labymod.addons.labycontroller.listener.ServerConnectionListener;
...
public class LabyControllerAddon extends LabyAddon<LabyControllerConfiguration> {
    ...
    private boolean forceKeyboardLike = false;
    ...
    protected void enable() {
        ...
        this.registerListener(new ServerConnectionListener(this));
    ...
    public boolean shouldUseKeyboardLikeMovement() {
        return configuration().keyboardLikeMovement().get() || forceKeyboardLike;
    }

    public void setForceKeyboardLike(boolean force) {
        this.forceKeyboardLike = force;
    }
