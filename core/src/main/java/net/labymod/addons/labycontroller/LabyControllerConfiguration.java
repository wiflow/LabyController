...
public class LabyControllerConfiguration extends AddonConfig {
    ...
    @SwitchSetting
    private final ConfigProperty<Boolean> keyboardLikeMovement = new ConfigProperty<>(false);

    @TextFieldSetting
    private final ConfigProperty<String> keyboardLikeServers = new ConfigProperty<>("");
    ...
    public ConfigProperty<Boolean> keyboardLikeMovement() {
        return this.keyboardLikeMovement;
    }

    public ConfigProperty<String> keyboardLikeServers() {
        return this.keyboardLikeServers;
    }
