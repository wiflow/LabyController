package net.labymod.addons.labycontroller.v1_19_4.input;
...
public class ControllerInput extends Input {
    ...
    public void tick(boolean slowDown, float movementMultiplier) {
        ...
        if (player.getAbilities().flying || (player.isInWater() && !player.isOnGround()) || player.getVehicle() != null) {
        ...
        if ((!player.getAbilities().flying && wasFlying && player.isOnGround()) || (!player.isPassenger() && wasPassenger)) sneakHeld = false;
