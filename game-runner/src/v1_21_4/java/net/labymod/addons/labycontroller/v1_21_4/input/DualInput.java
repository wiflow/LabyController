package net.labymod.addons.labycontroller.v1_21_4.input;
...
/**
 * Combines keyboard and controller input for Minecraft 1.21.4.
 * Uses ClientInput with forwardImpulse/leftImpulse and keyPresses record.
 */
