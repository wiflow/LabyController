package net.labymod.addons.labycontroller.v1_21_4.radial;
...
public class RadialMenuOpenerImpl implements RadialMenuHandler.RadialMenuOpener {
    ...
    public void executeAndClose(Object menu) {
        if (menu instanceof RadialMenuScreen radialMenu) radialMenu.executeSelection();
    }

    @Override
    public void closeMenu(Object menu) {
        if (menu instanceof RadialMenuScreen radialMenu) radialMenu.onClose();
    }

    @Override
    public boolean isScreenOpen() { return Minecraft.getInstance().screen != null; }
}
